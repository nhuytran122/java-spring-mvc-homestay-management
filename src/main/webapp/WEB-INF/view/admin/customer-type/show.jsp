    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="search-form-container my-4">
                <form action="/admin/customer/customer-type" method="get" class="search-form">
                    <input type="text" class="form-control form-control-sm" name="keyword" placeholder="Tìm kiếm phân loại khách hàng..." 
                            value="${keyword}">
                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="/admin/customer/customer-type/create" class="btn btn-primary btn-sm">
                                        ...
                                        <tbody>
                                            <c:choose>
                                                <c:when test="${empty listTypes}">
                                                    <tr>
                                                        <td colspan="7" class="text-center text-danger">Không tìm thấy phân loại khách hàng nào.</td>
                                                    </tr>
                                                </c:when>
                                                <c:otherwise>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="/admin/customer/customer-type/update/${type.customerTypeID}" class="btn btn-warning btn-sm" title="Sửa">
