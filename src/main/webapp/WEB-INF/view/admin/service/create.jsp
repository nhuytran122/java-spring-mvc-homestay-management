                    ...
                    >
                      ...
                      <div class="form-group row">
                        <label class="control-label col-sm-2"
                          >Tên dịch vụ <span class="text-danger">*</span></label
                        >
                        <div class="col-sm-10">
                          <form:input
                            type="text"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <form:input
                            type="text"
                            class="form-control number-separator ${not empty errorPrice ? 'is-invalid' : ''}"
                            path="price"
                          />
                          ${errorPrice}
                        </div>
                      ...
                      <div class="form-group row">
                        <label class="control-label col-sm-2"
                          >Đơn vị tính <span class="text-danger">*</span></label
                        >
                        <div class="col-sm-10">
                          <form:input
                            type="text"
                            class="form-control ${not empty errorUnit ? 'is-invalid' : ''}"
                            path="unit"
                          />
                          ${errorUnit}
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <form:hidden
                            path="icon"
                            id="selectedIcon"
                            class="${not empty errorIcon ? 'is-invalid' : ''}"
                          />
                          <button
                            type="button"
                          ...
                          >
                            <span
                              class="iconify"
                              data-icon="${not empty newCategory.icon ? newCategory.icon : 'mdi:help-circle'}"
                              data-width="20"
                              data-height="20"
                            ></span>
                            Chọn icon
                      ...
                      <%@ include
                      file="../layout/partial/_modal-show-list-icons.jsp" %>
