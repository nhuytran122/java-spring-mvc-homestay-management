          ...
          <div class="search-form-container my-4">
            ...
            >
              <input
                ...
                name="keyword"
                placeholder="Tìm kiếm phân loại đồ dùng..."
                value="${keyword}"
              />
                ...
                <div class="card position-relative">
                  <div class="card-body">
                    ...
                    >
                      ...
                      <a
                        href="/admin/inventory-category/create"
                            ...
                            <c:when test="${empty categories}">
                              <tr>
                                <td colspan="7" class="text-center text-danger">
                                  Không tìm thấy phân loại đồ dùng nào.
                                </td>
                              </tr>
                            </c:when>
                            <c:otherwise>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="btn-group" role="group">
                                      <a
                                        href="/admin/inventory-category/update/${category.categoryID}"
