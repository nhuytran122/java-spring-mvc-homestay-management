...
<head>
  ...
  <title>Thêm quy tắc chung</title>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4 text-center">Thêm mới quy tắc chung</h4>
                        <form:form class="form-horizontal" action="/admin/homestay-infor/rule/create" method="post"
                            ...
                            <div class="form-group row">
                                <label class="control-label col-sm-2">Tiêu đề nguyên tắc <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
