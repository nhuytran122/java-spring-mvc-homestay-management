...
<html lang="en">
  <head>
    ...
    />
    <title>Thêm mức giá phòng - ${newRoomPricing.roomType.name}</title>
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title mb-4 text-center">
                      Thêm mới mức giá phòng - ${newRoomPricing.roomType.name}
                    </h4>
                    <form:form
                      class="form-horizontal"
                      action="/admin/room-pricing/create"
                      method="post"
                      modelAttribute="newRoomPricing"
                    >
