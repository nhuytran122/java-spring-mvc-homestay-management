    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="search-form-container my-4">
                <form action="/admin/amenity-category" method="get" class="search-form">
                    <input type="text" class="form-control form-control-sm" name="keyword" placeholder="Tìm kiếm phân loại tiện nghi..." 
                            value="${keyword}">
