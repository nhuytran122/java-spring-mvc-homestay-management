        ...
        <div class="main-panel">
            <ul class="navbar-nav mr-lg-2 my-4">
                <li class="nav-item nav-search d-none d-lg-block" style="display: flex; align-items: center;">
                    <form action="/admin/amenity-category" method="get" class="d-flex" style="width: 100%; justify-content: center; align-items: center;">
                        <input type="text" class="form-control form-control-sm me-2" name="keyword" placeholder="Tìm kiếm phân loại tiện nghi..." 
                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="/admin/amenity-category/create" class="btn btn-primary btn-sm">
                                        ...
                                        <tbody>
                                            <c:choose>
                                                <c:when test="${empty categories}">
                                                    <tr>
                                                        <td colspan="7" class="text-center text-danger">Không tìm thấy phân loại tiện nghi nào.</td>
                                                    </tr>
                                                </c:when>
                                                <c:otherwise>
                                                    <c:forEach var="category" items="${categories}">
                                                        <tr>
                                                            <td><span class="iconify" data-icon="${category.icon}" data-width="24" data-height="24"></span> ${category.categoryName}</td>
                                                            <td>
                                                                ${category.description}</td>
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="/admin/amenity-category/update/${category.categoryID}" class="btn btn-warning btn-sm" title="Sửa">
