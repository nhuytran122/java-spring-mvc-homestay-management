                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="form-horizontal" action="/admin/warehouse/export" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <form:input type="text" class="form-control number-separator
                                                ${not empty errorQuantity ? 'is-invalid' : ''}" 
                                                path="quantity" />
                                            ${errorQuantity}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-offset-2 col-sm-10 text-center">
                                            <a href="/admin/warehouse" class="btn btn-secondary">Hủy</a>
