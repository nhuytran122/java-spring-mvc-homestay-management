                        ...
                        <div class="row g-4">
                            <div class="col-md-12 text-center mb-3">
                                ...
                                <div class="mb-3">
                                    <img src="/images/avatar/${not empty sessionScope.avatar ? sessionScope.avatar : 'default-img.jpg'}" 
                                         alt="Avatar" class="rounded-circle border border-primary border-2" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3">${sessionScope.fullName}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3">${customer.phone}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3">${customer.email}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3">${customer.address}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3"><fmt:formatNumber type="number" value="${customer.rewardPoints}" /></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="form-control form-control-lg rounded-end-3">${customer.customerType.name}</span>
                                </div>
                            </div>

                            <div class="col-12 text-center mt-4">
                                <a href="/profile/update" class="btn btn-primary btn-lg rounded-3 me-2">
                                    <i class="fa fa-edit"></i> Cập nhật thông tin
                                </a>
                                <a href="/change-password" class="btn btn-outline-primary btn-lg rounded-3">
                    ...
                    <div class="card-body p-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="fa fa-calendar-check me-2 text-primary"></i> Số lần đặt phòng</span>
                                <span class="fw-bold">${countBooked}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="fa fa-money-bill me-2 text-primary"></i> Tổng chi tiêu</span>
                                <span class="fw-bold"><fmt:formatNumber type="number" value="${paidTotal}" />đ</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="fa fa-check-circle me-2 text-primary"></i> Đặt phòng hoàn tất</span>
                                <span class="fw-bold">${countCompleted}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="fa fa-times-circle me-2 text-primary"></i> Đặt phòng đã hủy</span>
                                <span class="fw-bold">${countCancelled}</span>
                            </li>
                        </ul>
                        <a href="/booking/booking-history" class="btn btn-outline-warning btn-sm w-100 mt-3 rounded-3">
