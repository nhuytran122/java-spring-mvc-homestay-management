        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead mb-4">Vui lòng kiểm tra thông tin đặt phòng và dịch vụ của bạn. Chọn phương thức thanh toán và tiếp tục để hoàn tất đặt phòng.</p>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="bookingService" items="${booking.bookingServices}">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <fmt:formatNumber type="number" value="${bookingService.totalPrice}" />đ
                                                                    </td>
                    ...
                    <div class="action-buttons my-4">
                        <div class="btn-group" role="group">
                            <a href="/booking/payment?bookingID=${booking.bookingID}&paymentOption=deposit" class="btn btn-primary btn-lg me-2">
                                <i class="bi bi-credit-card"></i> Cọc 50% (<fmt:formatNumber type="number" value="${booking.totalAmount * 0.5}" />đ)
                            </a>
                            <a href="/booking/payment?bookingID=${booking.bookingID}&paymentOption=full" class="btn btn-primary btn-lg">
                                <i class="bi bi-credit-card"></i> Thanh toán 100% (<fmt:formatNumber type="number" value="${booking.totalAmount}" />đ)
                            </a>
                        </div>
                    </div>
                </div>
